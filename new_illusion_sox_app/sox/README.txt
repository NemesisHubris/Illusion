TITLE: Sox Media Player

CONTAINS: KUAL extension to play media on newer kindles with USB or BT audio

NOTES:

This is the third release of this KUAL package which includes Sox and all
dependencies.  Minor fixes are included.


THIS IS THE VERSION FOR HF FIRMWARE!  IT WILL NOT WORK ON EARLIER FIRMWARE!
...
PLEASE NOTE: Sox does NOT support AAC!  Any attempts to play AAC will fail.

Per Sox:

AUDIO FILE FORMATS: 8svx aif aifc aiff aiffc al amb amr-nb amr-wb anb au avr awb
                    caf cdda cdr cvs cvsd cvu dat dvms f32 f4 f64 f8 fap flac
                    fssd gsm gsrt hcom htk ima ircam la lpc lpc10 lu mat mat4
                    mat5 maud mp2 mp3 nist ogg paf prc pvf raw s1 s16 s2 s24 s3
